...
<div id="shadow">
            <div id="email">
              ...
              <form @submit.prevent="AddUser()" id="form" method="post">
                  <div>
                      <label for="username"> Username </label>
                        <input type="text" v-model="username" name="username" placeholder="Username" id="username" required> 
                  </div>
                  <div>
                  ...
                  <div>
                      <label for="birth"> Age </label>
                        <input type="number" v-model="birth" min="13" step="1" name="birth" id="age" required> 
                  </div>
                  <div>
                  ...
                  <!--<div>
                      <label for="confirmpassword"> Confirm Password </label>
                        <input type="password" v-model="confirmpassword" name="confirmpassword" placeholder="Confirm Password" id="confirmpassword" required> 
                  </div> -->
                   <div>
                ...
                <option value="Zimbabwe">Zimbabwe</option>
                  ...
                  <div>
                        <button @v-on:click="AddUser()" id="css" type="submit" > Register </button>
                  </div>
                    </form>
            </div>
